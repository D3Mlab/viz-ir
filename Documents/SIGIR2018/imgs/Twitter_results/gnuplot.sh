...
#set xtics (10,100, 1000,10000)
#set xtics nomirror rotate by -45
set ylabel "F1-Score (Opt EF1-Score)" font "Courier,15"
set xlabel "F1-Score (Opt F1-Score)" font "Courier,15"
set term postscript eps enhanced color "Courier,16"
...
plot "AUI4IR_results/scatter_plot2_lambda_0.9.txt" using 2:1 notitle '{/Symbol l}=0.9'  with points lw 1 ps 0.5 pt 7 lc 2,\
 f1(x) notitle lw 2  lc 2,\
 x notitle lc 'black'


set output "scatter_plot2_EF1.vs.F1_lambda_0.8.eps"
 plot "AUI4IR_results/scatter_plot2_lambda_0.8.txt" using 2:1 notitle '{/Symbol l}=0.8'  with points lw 1 ps 0.5 pt 7 lc 6,\
  f2(x) notitle lw 2  lc 6,\
  x notitle lc 'black'



set output "scatter_plot2_EF1.vs.F1_lambda_0.7.eps"
plot "AUI4IR_results/scatter_plot2_lambda_0.7.txt" using 2:1 notitle '{/Symbol l}=0.7'  with points lw 1 ps 0.5 pt 7 lc 4,\
  f3(x) notitle lw 2  lc 4,\
  x notitle lc 'black'
...
plot "AUI4IR_results/scatter_plot2_lambda_0.6.txt" using 2:1 notitle '{/Symbol l}=0.6'  with points lw 1 ps 0.5 pt 7 lc 7,\
 f4(x) notitle lw 2  lc 7,\
 x notitle lc 'black'
