...
//        training_b = 1;
        ...
        String algo = request.getParameter("algo_in_use");
        ...
        String nd1,nd2,nd3,nd4,nd5,nd6,nd7,nd8,nd9,nd10,nd11,nd12;
        String all_nds = "";
        ...
        bqNDs.add(neg, BooleanClause.Occur.SHOULD);
         ...
         // Check if in training mode
            ...
            TermQuery pos4 = new TermQuery(new Term(Indexer.TYPE, nd4));
            TermQuery pos5 = new TermQuery(new Term(Indexer.TYPE, nd5));
            TermQuery pos6 = new TermQuery(new Term(Indexer.TYPE, nd6));
            TermQuery pos7 = new TermQuery(new Term(Indexer.TYPE, nd7));
            TermQuery pos8 = new TermQuery(new Term(Indexer.TYPE, nd8));
            TermQuery pos9 = new TermQuery(new Term(Indexer.TYPE, nd9));
            TermQuery pos10 = new TermQuery(new Term(Indexer.TYPE, nd10));
            TermQuery pos11 = new TermQuery(new Term(Indexer.TYPE, nd11));
            TermQuery pos12 = new TermQuery(new Term(Indexer.TYPE, nd12));
            ...
            bqNDs.add(pos4, BooleanClause.Occur.SHOULD);
            bqNDs.add(pos5, BooleanClause.Occur.SHOULD);
            bqNDs.add(pos6, BooleanClause.Occur.SHOULD);
            bqNDs.add(pos7, BooleanClause.Occur.SHOULD);
            bqNDs.add(pos8, BooleanClause.Occur.SHOULD);
            bqNDs.add(pos9, BooleanClause.Occur.SHOULD);
            bqNDs.add(pos10, BooleanClause.Occur.SHOULD);
            bqNDs.add(pos11, BooleanClause.Occur.SHOULD);
            bqNDs.add(pos12, BooleanClause.Occur.SHOULD);
    ...
    DataBaseUtils.Answers answers = new DataBaseUtils.Answers();
         ...
         <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
             <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Visualization tool</a> 
                ...
                <%
                    if(training_b == 0 && training_f == 0){
                        ...
                        out.println("<h2 style=\"color:red; font-style: \"> <b>Relevance-driven clustering. </b> </h2>");                             
                    }  else if(algo.equals("kmeans")){
           ...
           <ul class="navbar-nav px-3">
                <li class="nav-item text-nowrap">
                    <a class="nav-link" href="index.jsp" style="font-weight: bold">Sign out  Userid: Test</a>
                </li>                
            </ul> 
        </nav> 
              ...
              <main class="col-md-10 ml-sm-auto col-lg-10 pt-3 px-4">
                ...
                <form class="form-check" id="mapform">
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-8 autocomplete">
                                ...
                                <div class="col-lg-2">
                                       <select class="form-control" name="algo_in_use"  required>
                                           <option value="baseline" <% if(algo.equals("baseline")){
                                                out.print("selected=\"selected\"");
                                            } %>>Baseline</option>
                                        <option value="kmeans" <% if(algo.equals("kmeans")){
                                                out.print("selected=\"selected\"");
                                            } %>>K-Means</option>
                                        <option value="filters" <% if(algo.equals("filters")){
                                                out.print("selected=\"selected\"");
                                            } %>>Relevance-driven clustering</option>
                                       </select>
                                </div>
                                <div class="col-lg-2">
                ...
                if (!algo.startsWith("baseline")) {
                    for (SetSelector.Filter filter : filters) {
                        ...
                        for (Document doc : filter.getOutList()) {
                            ...
                            int low = 8000;
                            int high = 10000;
                            p = (double)(r.nextInt(high-low) + low)/10000;
                            location += ("['" + id + "',"
