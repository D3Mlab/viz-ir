...
public class update_indexer {
    ...
    public static void main(String[] args) throws ParseException, Exception {
        String dir = "/media/Storage/reda/netbeans-8.2/apache-tomcat-9.0.8/bin/ND_data_index_v6.0/";
        ...
        long del = writer.deleteDocuments(q);
        System.out.println("Number of documents deleted: " + del);
        writer.commit();
        writer.flush();
    }
