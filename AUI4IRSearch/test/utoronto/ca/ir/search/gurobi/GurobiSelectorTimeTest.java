...
import utoronto.ca.ir.search.exhaustive.ExhaustiveSelectorTime;
 ...
 * @author rbouadjenek
 */
public class GurobiSelectorTimeTest {
    ...
    public void testGurobiSelectorTimeTest() throws Exception {
        ...
        GurobiSelectorTime selector1 = new GurobiSelectorTime("/media/Storage/reda/Documents/AUI4IR_data/raw_enron_index_v1.0/", 50);
        ExhaustiveSelectorTime selector2 = new ExhaustiveSelectorTime(selector1.is, selector1.malicious);
        selector2.perm = selector1.perm;
        for (int i = 0; i < 100; i++) {
            List<String> ids = selector1.getRandomData(100);
...
//                System.out.print(date + ",");
            ...
            System.out.println("] -> " + se.getExpectedSetScore(selector1.getIds(hits1), sf));
